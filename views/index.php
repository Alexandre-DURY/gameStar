            ...
            <div class="col-lg-9">
                <div class="row">
                    ...
                    if (isset($_POST['categorie'])) {
                        $tabFromCat = PicturesFromCategorie($_POST['categorie'], $link);
                        if (isset($tabFromCat)) {
                            foreach ($tabFromCat as $PictureCat) {
                                if ($PictureCat['cache'] == 0) { ?>
                                    <div class='col-lg-4 col-md-6 mb-4'>
                                        <div class='card h-100'>
                                            ...
                                            <div class='card-footer'>
                                                <?php
                                                if ($PictureCat['etoile'] == '1') { ?>
                                                    <small class='text-muted'>&#9733; &#9734; &#9734; &#9734; &#9734;</small>
                                                <?php }
                                                if ($PictureCat['etoile'] == '2') { ?>
                                                    <small class='text-muted'>&#9733; &#9733; &#9734; &#9734; &#9734;</small>
                                                <?php }
                                                if ($PictureCat['etoile'] == '3') { ?>
                                                    <small class='text-muted'>&#9733; &#9733; &#9733; &#9734; &#9734;</small>
                                                <?php }
                                ...
                                ?>
                                    <div class='col-lg-4 col-md-6 mb-4'>
                                        <div class='card h-100'>
                                            ...
                                            <div class='card-footer'>
                                                <?php
                                                if ($onePicture['etoile'] == '1') { ?>
                                                    <small class='text-muted'>&#9733; &#9734; &#9734; &#9734; &#9734;</small>
                                                <?php }
                                                if ($onePicture['etoile'] == '2') { ?>
                                                    <small class='text-muted'>&#9733; &#9733; &#9734; &#9734; &#9734;</small>
                                                <?php }
                                                if ($onePicture['etoile'] == '3') { ?>
                                                    <small class='text-muted'>&#9733; &#9733; &#9733; &#9734; &#9734;</small>
                                                <?php }
